...
<head>
    ...
    <title>User Management - DriveWise Admin</title>
...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600">Manage DriveWise users</p>
        </div>
        
        <div class="bg-white rounded-lg shadow">
            <div class="p-6">
                <p class="text-gray-600">User management content will be added here...</p>
            </div>
        </div>
    </div>
